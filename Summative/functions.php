...
register_nav_menus(['primary'=> 'Matts Primary Menu']);
...
function add_news_metabox(){
  add_meta_box(
    'news_metabox', // id in dashboard
    'Our First Metabox', // title seen in the dashboard
    'news_metabox_callback', // callback function to run and render the elements
    'news', // custom post type to attach it //
...
add_action('admin_menu','add_news_metabox');

// save our fruit metabox

function news_save_metabox_data($post_id, $post){
...
add_action('save_post', 'news_save_metabox_data', 10, 2);
...
function my_first_customise_option($wp_customize) {
  ...
  $wp_customize->add_setting("my_frontpage_message2", array(
    "default" => ""
  ));
...
//background color picker
  ...
  $wp_customize->add_setting("color_picker2", array(
    "default" => 0
  ));

  $wp_customize->add_setting("color_picker3", array(
    "default" => 0
  ));

  $wp_customize->add_setting("color_picker4", array(
    "default" => 0
  ));
  ...
  $wp_customize->add_control(new WP_Customize_Color_Control($wp_customize, 'color_picker', array(
    ...
    $wp_customize->add_control(new WP_Customize_Color_Control($wp_customize, 'color_picker2', array(
        'label' => 'background Colors',
        'section' => 'tims_section',
        'settings' => 'color_picker2'
      )));

      $wp_customize->add_control(new WP_Customize_Color_Control($wp_customize, 'color_picker3', array(
          'label' => 'posts background Colors',
          'section' => 'tims_section',
          'settings' => 'color_picker3'
        )));

        $wp_customize->add_control(new WP_Customize_Color_Control($wp_customize, 'color_picker4', array(
            'label' => 'Text-2 colors',
            'section' => 'tims_section',
            'settings' => 'color_picker4'
          )));
  ...
  $wp_customize->add_control("my_custom_message2", array(
    "label" => "Enter a second post text message",
    "section" => "tims_section",
    "settings" => "my_custom_message2",
    "type" => "textarea"
  ));

  $wp_customize->add_control("my_custom_message3", array(
    "label" => "Enter a third post text message",
    "section" => "tims_section",
    "settings" => "my_custom_message3",
    "type" => "textarea"
  ));
  ...
  $wp_customize->add_control("my_frontpage_message2", array(
    "label" => "Enter a front page message 2",
    "section" => "tims_section",
    "settings" => "my_frontpage_message2",
    "type" => "textarea"
  ));
